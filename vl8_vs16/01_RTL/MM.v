module MM #(
    ...
    output  [m+k-1:0]       o_addr_a,
    output  [n+k+ad-1:0]    o_addr_b,
    output                  o_out_valid,
...
assign o_addr_a = {cnt[m+n+k+ad-1:n+k+ad], cnt[k+ad-1:ad]};
assign o_addr_b = {cnt[n+k+ad-1:k+ad], cnt[ad-1:0], cnt[k+ad-1:ad]};
